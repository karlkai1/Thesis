...
# === CONFIGURATION ===
input_poi_file = "../output/snapped_delivery_points_bike_preferred.poi.xml"
output_trips_file = "../output/mlh_trip_matrix.xml"

# MLH depot coordinates (will be loaded from file)
try:
    with open('../output/mlh_depot_coords.txt', 'r') as f:
...
print("\n📋 NEXT STEPS:")
print("1. Run duarouter to calculate distances (from 02_mlh_scenario directory):")
print("   duarouter -n output/MUNET_EXTREME_bike.net.xml --route-files output/mlh_trip_matrix.xml \\")
print("     --additional-files input/cargo_bike_type.add.xml \\")
print("     -o output/mlh_trip_matrix_routes_bike.rou.xml \\")
